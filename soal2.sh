...
END 	{
	...
	print "Peringkat pertama: ", p1, ", dengan total penjualan sebesar: ", maxp1
	print "Peringkat kedua: ", p2, ", dengan total penjualan sebesar: ", maxp2
	print "Peringkat ketiga: ", p3, ", dengan total penjualan sebesar: ", maxp3, "\n"
	...
	print "Personal Accessories: ", prod1, ", dengan jumlah: ", maxprod1
	print "Camping Equipment: ", prod2, ", dengan jumlah: ", maxprod2
	print "Outdoor Protection: ", prod3, ", dengan jumlah: ", maxprod3, "\n"
}
